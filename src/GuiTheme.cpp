...
void GuiTheme::setup()
{
    ...
    style->Colors[ImGuiCol_WindowBg] = ImVec4(col_main_area, 0.58f);
    ...
    style->Colors[ImGuiCol_PopupBg] = ImVec4(col_win_popup, 0.32f);
    style->Colors[ImGuiCol_ButtonHovered] = ImVec4(col_main_head, 0.78f);
    style->Colors[ImGuiCol_ButtonActive] = ImVec4(col_main_head, 1.00f);
